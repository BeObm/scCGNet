...
#SBATCH --time=29:45:50             # total run time limit (HH:MM:SS)
#SBATCH --account=rrg-hup           # rrg-hup - // def-hup-ab
#SBATCH --output=logs/Campbell.out      # standard output file
#SBATCH --error=logs/Campbell.txt       # standard error file
